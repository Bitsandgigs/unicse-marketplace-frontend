...
function OrdersAndGMVCard() {
  return (
    <div
      className="rounded-lg shadow-sm bg-white p-4 w-full h-full"
    >
      <div
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="px-2 py-1 rounded-md text-sm text-gray-600">
            Jan 2025 - Dec 2025
          </div>
        </div>
      </div>
...
function MarginAppliedCard() {
  return (
    <div className="rounded-lg shadow-sm bg-white p-4 h-[200px]">
